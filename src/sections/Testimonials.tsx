...
export const TestimonialsSection = () => {
  return <div className="py-16 lg:py-24">
    ...
    <div className="mt-12 flex overflow-x-clip [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] py-4 -my-4 lg:mt-20">
      <div className="flex-none flex gap-8 pr-8 animate-loopinf [animation-duration:90s] hover:[animation-play-state:paused]">
        {[...new Array(2).fill(0).map((_,i)=>(
          <Fragment key={i}>

          
      {testimonials.map(testimonial=>(
        <Card className="max-w-xs md:p-8 md:max-w-md hover:-rotate-3 transition duration-300" key={testimonial.name}>
