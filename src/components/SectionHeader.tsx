...
export default function SectionHeader({title,eyebrow,description}:{title:string,eyebrow:string,description:string}) {
  return (
    <>
        ...
        <h2 className="font-serif md:text-5xl text-3xl text-center mt-6">{title}</h2>
        <p className="text-center lg:text-xl md:text-lg max-w-md mx-auto text-white/60 mt-4">{description}</p>
